#!/bin/bash
# =============================================================
# Feature ablation: ATNET k-NN graph variants × 4 seeds.
...
KNN_GRAPHS="${KNN_GRAPHS:-ATNET_KNN_BEHAV_k10 ATNET_KNN_PURE_k10 ATNET_KNN_STRUCT_k10 ATNET_KNN_HYBRID_k10 ATNET_KNN_FEAT_k10}"

RESULT="./results/appendix/feature_ablation.csv"
HP="--lr 0.0005 --hidden_dim 256 --gconv_nlayers 2"
COMMON="--node_data_name atnet/ATNET_NODE_FEAT --edge_data_name atnet/ATNET_EDGES --skip_tsne --encoder_type gbt"
