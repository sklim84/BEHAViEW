...
def main():
    ...
    # Load labels
    node_df = pd.read_csv(os.path.join(base, 'datasets/atnet/ATNET_NODE_FEAT.csv'))
    ...
    # Graphs to measure
    graphs = [
        ('Transaction (original)', 'datasets/atnet/ATNET_EDGES.csv', True),
        ('Behavioral k-NN (A, 8 feats)', 'datasets/atnet/ATNET_KNN_BEHAV_k10.csv', False),
        ('Feature k-NN (A+B1, 12 feats)', 'datasets/atnet/ATNET_KNN_FEAT_k10.csv', False),
        ('Structural k-NN (B, 11 feats)', 'datasets/atnet/ATNET_KNN_STRUCT_k10.csv', False),
        ('Centrality k-NN (B2, 7 feats)', 'datasets/atnet/ATNET_KNN_CEN_k10.csv', False),
        ('Hybrid k-NN (A+B, 19 feats)', 'datasets/atnet/ATNET_KNN_HYBRID_k10.csv', False),
    ]
