...
def main():
    ...
    df, behav_cols = load_features(os.path.join(base, 'datasets', 'atnet', 'ATNET_NODE_FEAT.csv'))
    ...
    adj_tx = build_tx_adjacency(os.path.join(base, 'datasets', 'atnet', 'ATNET_EDGES.csv'),
                                account_to_idx)
