# RQ1 results — Homophily Recovery (Table 3, Table 4, Table 5, Figure 1)
...
| `feature_topology_gap.csv` | `scripts/rq1/summarize_feature_topology_gap.py` | Diagnostic separating behavioral feature separability from topology repair |
